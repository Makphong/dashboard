...
export function FilterBar({
  ...
  const filteredSegmentTypeOptions = segmentTypeOptions.map(val => ({ label: val, value: val })).filter((option) => 
    option.label.toLowerCase().includes(segmentTypeSearchText.trim().toLowerCase())
  );
